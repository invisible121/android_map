...
public class User_entityController {
    ...
    public Response addAccount(
        ...
        return registerBO(userName, passwd, Integer.parseInt(group));
    }
...
//                }
    ...
    public Response registerBO(String userName, String passwdMD5, int group) {
        ...
        if (user == null) {
            ...
            Rights rights = new Rights(group, newUser.getId());
